...
function NewProduct() {
    ...
    function showWidget() {
        const widget = window.cloudinary.createUploadWidget(
            {
                cloudName: "mernstack-proj01", // this is from the cloudinary account
                uploadPreset: "pzpzaa56_first", // this is a credential from the cloudinary account(upload preset unsigned name) 
            },
            (error, result) => {
